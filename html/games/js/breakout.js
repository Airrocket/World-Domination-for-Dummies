...
function drawFail() {
  ...
  cx.font = "50px Arial Black";
  cx.fillStyle = "black";
  cx.fillText("Game Over!", canvas.width/2-160, 100 );
  cx.fillText("You got a", canvas.width/2-135, 200 );
  cx.fillText("score of " + score.toString(), canvas.width/2-140, 250 );
...
function drawWin() {
  ...
  cx.font = "50px Arial Black";
  cx.fillStyle = "black";
  cx.fillText("You Win!", canvas.width/2-120, canvas.height/2);
  document.getElementById('start').style.display = 'inline';
  score = 0;
};
